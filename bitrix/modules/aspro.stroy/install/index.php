...
class aspro_stroy extends CModule {
	...
	function InstallEvents(){
		...
		RegisterModuleDependences("iblock", "OnAfterIBlockSectionAdd", $this->MODULE_ID, self::moduleClass, "OnAfterIBlockSectionAddHandler");
		RegisterModuleDependences("iblock", "OnAfterIBlockSectionUpdate", $this->MODULE_ID, self::moduleClass, "OnAfterIBlockSectionUpdateHandler");
		RegisterModuleDependences("iblock", "OnAfterIBlockSectionDelete", $this->MODULE_ID, self::moduleClass, "OnAfterIBlockSectionDeleteHandler");
		return true;
	}
	...
	function UnInstallEvents(){
		...
		UnRegisterModuleDependences("iblock", "OnAfterIBlockSectionAdd", $this->MODULE_ID, self::moduleClass, "OnAfterIBlockSectionAddHandler");
		UnRegisterModuleDependences("iblock", "OnAfterIBlockSectionUpdate", $this->MODULE_ID, self::moduleClass, "OnAfterIBlockSectionUpdateHandler");
		UnRegisterModuleDependences("iblock", "OnAfterIBlockSectionDelete", $this->MODULE_ID, self::moduleClass, "OnAfterIBlockSectionDeleteHandler");
		return true;
	}
