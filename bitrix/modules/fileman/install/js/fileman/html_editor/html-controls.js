...
*/
		...
		else
		{
			...
			else if (href != '')
			{
				...
				else if (href.indexOf("://") !== -1 || href.substr(0, 'www.'.length) == 'www.' || href.indexOf("&goto=") !== -1)
				{
					...
					if(href.substr(0, '/bitrix/redirect2.php'.length) == '/bitrix/redirect2.php')
					{
						this.pStat.checked = true;
						this.CheckShowStatParams();
						var sParams = href.substring('/bitrix/redirect2.php'.length);
	...
	LinkDialog.prototype.GetValues = function()
	{
		...
		else if (type == 'external')
		{
			...
			{
				value.href = '/bitrix/redirect2.php?event1=' + escape(this.pStatEvent1.value) + '&event2=' + escape(this.pStatEvent2.value) + '&event3=' + escape(this.pStatEvent3.value) + '&goto=' + escape(value.href);
			}
		}
		else if (type == 'anchor')
		{
