...
<div class="reviews-reply-form" style="display:none;" <?=(($arParams['SHOW_MINIMIZED'] == "Y") ? 'style="display:none;"' : '' )?>>
	<?else:?>
...
<div class="col-lg-6 col-xs-6 rating"></div>
	...
	<div style="position:relative; display: block; width:100%;">
		...
		<input style="display: none;"  name="UF_ELEMENT_ID" id="UF_ELEMENT_ID" size="30" type="text" value="<?=$arParams["ELEMENT_ID"]?>" />
