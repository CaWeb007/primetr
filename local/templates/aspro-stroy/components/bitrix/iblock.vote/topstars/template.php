...
?><table class="bx_item_detail_rating">
	<tr>
		...
		<td>
			<span class="red-color" id="<?=$arJSParams["rankId"]?>"></span>
			<span id="<?=$arJSParams["ratingId"]?>" class="bx_stars_rating_votes"><a href="#reviews-block" class="reviews-link">(0) отзыва</a></span>
