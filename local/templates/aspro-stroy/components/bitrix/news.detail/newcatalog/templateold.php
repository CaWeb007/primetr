										...
										<?if($isPrices):?>
											<div class="item_f <?//=(!$isSizes ? 'col-md-12 col-sm-12 col-xs-12' : 'col-md-8 col-sm-8 col-xs-12 ws')?>">
												<div class="price">
													...
													<//?=CStroy::FormatPriceShema($arResult['DISPLAY_PROPERTIES']['PRICE']['VALUE'])?>
...
<div class="row nomargin under_content">
	<div class="maxwidth-theme">
		<div class="col-md-12">
			...
			<h4 class="title_block"><?/*=(strlen($arParams['T_GALLERY']) ? $arParams['T_GALLERY'] : GetMessage('T_GALLERY'))*/?>Наши работы</h4>
					<div class="item-views portfolio front">
						<div class="row" itemscope itemtype="http://schema.org/ItemList">
							<?foreach($arResult["GALLERY_BIG"] as $key => $arBigItem){?>
                                <input type="hidden" class="test_class" value="<?=$key?>">
