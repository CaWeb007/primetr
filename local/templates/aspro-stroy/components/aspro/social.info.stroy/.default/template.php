...
<div class="social-icons">
	...
	<ul>
		...
		<?if(!empty($arResult['SOCIAL_ODNOKLASSNIKI'])):?>
			<li class="lj">
				<a href="https://ok.ru/group/54150876037199" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_ODNOKLASSNIKI')?>">
		...
		<?if(!empty($arResult['SOCIAL_GOOGLEPLUS'])):?>
			<li class="lj">
				<a href="<?=$arResult['SOCIAL_GOOGLEPLUS']?>" class="telegram" target="_blank" rel="nofollow" title="<?=GetMessage('TEMPL_SOCIAL_TELEGRAM')?>">
